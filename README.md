...
[![Version](https://img.shields.io/badge/version-v2.16.1-brightgreen?style=flat-square)](./PATCH.md)
...
- 랭킹 알림은 최근 순위 진입과 추월 이벤트를 오버레이로 표시합니다.
...
- `settingsStore`: 랭킹/후원 알림 on/off 설정
...
- 텍스트 리소스는 `ko`, `en`, `ja` locale을 함께 관리합니다.
