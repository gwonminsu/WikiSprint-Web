...
## v2.16.1
- 设置页面中的通知开关在浅色模式下变得更清晰了。
- 开关圆点在关闭时更靠左、开启时更靠右，移动范围经过了细致调整。

## v2.16.0
- 现在可以在设置页面中分别开启或关闭排行榜通知与赞助通知。
- 重新开启赞助通知后，只会显示开启之后收到的新赞助通知。

---

## v2.15.0
- 当你通关后，如果日榜总排行发生变化，现在会立即在画面上显示通知。
- 你也能看到其他玩家新进入排行榜或超越他人的提示通知。

---

## v2.14.0
- 新增了更新日志页面。
- 现在可以直接在更新日志页面查看最近的更新内容。

---

## v2.13.3
- 当其他标签页已经有一局正在进行时，现在会更可靠地阻止再次开始新游戏。
- 游戏现在会更清楚地说明开始失败的原因。

## v2.13.2
- 修复了未登录游玩后再登录时，记录恢复可能错乱的问题。
- 对于无法安全恢复的记录，现在会更清楚地处理，而不是错误恢复。

## v2.13.1
- 在提交举报和管理员操作前，新增了一步确认流程。
- 对文档页面和赞助页面的若干交互做了更自然、更稳定的调整。`;
