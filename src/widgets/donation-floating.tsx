  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-200">
      ...
      <div className="pointer-events-none absolute bottom-6 right-6 flex max-w-[calc(100vw-1.5rem)] flex-col items-end gap-3">
        <div
          className={[
            'pointer-events-auto origin-bottom-right overflow-hidden rounded-[2rem]',
            ...
            <div className="flex items-center gap-3">
              {isCheckoutOpen ? (
                <button
                  ...
                  className="inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-white text-lg font-black text-slate-700 transition hover:-translate-y-[1px] hover:bg-sky-50 dark:bg-slate-900 dark:text-slate-100 dark:hover:bg-slate-800"
            ...
            {isCheckoutOpen ? (
              ...
              <div className="py-5">
                ...
                <button
                  ...
                  className="mt-5 w-full rounded-[1.3rem] bg-sky-400 px-4 py-4 text-sm font-black text-white shadow-[0_16px_38px_rgba(14,165,233,0.28)] transition hover:-translate-y-[1px] hover:bg-sky-300"
                >
        ...
        <button
          ...
          className="pointer-events-auto inline-flex items-center gap-3 rounded-[1.35rem] bg-sky-400 px-4 py-2 text-white shadow-[0_18px_42px_rgba(14,165,233,0.36)] transition hover:-translate-y-[1px] hover:bg-sky-300"
        >
